...
![](http://images.scar.site/2022-02-18-00-01-22-image.png)
...
* 给你发个**网卡**，每次刷网卡核对网吧有没有你信息
  ![](http://images.scar.site/20220329085523.png)
* 给你发个**冒险小虎队卡**，前台小姐姐拿着解密卡扫一下拿到里面的信息，发现是你的大脸并给你上了两小时钟

![](http://images.scar.site/飞书20220321-094345.jpg)
...
Session ID 就等于服务端给你发放的一张网卡，后续你每次请求服务的时候，都要带上 Session ID，服务端通过 ID 查到状态信息后返回给客户端。过程如图：
![](http://images.scar.site/2022-02-18-00-04-40-image.png)
